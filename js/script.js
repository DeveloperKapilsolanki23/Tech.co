...
const videoPlay = document.querySelector("#playVideo");
const videoCont = document.querySelector("#videoCont");
const videoRem = document.querySelector(".video_wrap");
videoPlay.addEventListener("click", () => (
    videoCont.classList.toggle('active-Btn')
))
videoRem.addEventListener("click", () => (
    videoCont.classList.remove('active-Btn')
))